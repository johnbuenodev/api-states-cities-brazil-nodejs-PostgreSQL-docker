...
create table brazil.state (
    id_state bigint NOT NULL CONSTRAINT id_state_pk PRIMARY KEY,
    name_state varchar(100) DEFAULT NULL,
    iso_state varchar(5) DEFAULT NULL
); 

INSERT INTO brazil.state (id_state, name_state, iso_state) VALUES
(1, 'Acre', 'AC'),
(2, 'Alagoas', 'AL'),
(3, 'Amazonas', 'AM'),
(4, 'Amapá', 'AP'),
...
create table brazil.city (
    id_city bigint NOT NULL CONSTRAINT id_city_pk PRIMARY KEY,
    name_city varchar(120) DEFAULT NULL,
    id_state bigint DEFAULT NULL,
    CONSTRAINT id_state_fk
      FOREIGN KEY(id_state) 
	  REFERENCES brazil.state(id_state)
);

INSERT INTO brazil.city (id_city, name_city, id_state) VALUES
(1, 'Afonso Cláudio', 8),
